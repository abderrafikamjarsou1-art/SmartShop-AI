...
export interface ApiAuthContext {
  ...
  /** Every screen that renders a money amount needs this, regardless of
   * role — unlike GET /api/business (settings:manage only), this is safe
   * to expose to any authenticated member since it's read-only display
